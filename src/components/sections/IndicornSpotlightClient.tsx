...
const FALLBACK_HEADING = "Indicorns: Celebrating India's Enduring Startups";
const FALLBACK_BULLETS = ["Profitable", "₹100 Cr+ revenue", "Founded < 15 years"];
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {bullets.map((b, i) => (
              <span key={`bullet-${i}`} className="contents">
                <span>{b}</span>
                {i < bullets.length - 1 && (
                  <span
