...
export interface BackedEarlyCompany {
  name: string;
  bgImage: string;
  logo: string;
  logoScale?: number;
...
export interface BackedEarlyData {
  headingFirst?: string;
...
/* ═══════════════════════════════════════════════════════
   CompanyCard
   ═══════════════════════════════════════════════════════ */
function CompanyCard({ company, mode = "marquee" }: { company: BackedEarlyCompany; mode?: "marquee" | "grid" }) {
...
/* ═══════════════════════════════════════════════════════
   ...
   ═══════════════════════════════════════════════════════ */
function CardMarquee({ companies }: { companies: BackedEarlyCompany[] }) {
...
/* ═══════════════════════════════════════════════════════
   Main Component
   ═══════════════════════════════════════════════════════ */
export default function BackedEarlyClient({
  data,
}: {
  data?: BackedEarlyData | null;
}) {
    ...
    >
      ...
      <div className="relative z-10 flex w-full flex-1 flex-col items-center justify-between">
        ...
        <div className="flex w-full flex-1 flex-col items-center justify-center mb-[clamp(32px,min(4vw,6vh),60px)] max-md:!flex-none max-md:!justify-start max-md:!mt-[clamp(44px,16vw,80px)] max-md:!mb-[clamp(16px,4vw,28px)]">
          <div className="flex w-full flex-col items-center">
            ...
            >
              ...
              {[headingFirst, headingSecond].filter(Boolean).map((line, li) => {
        ...
        <div className="w-full shrink-0">
          <CardMarquee companies={companies} />
          <MobileFadingGrid companies={companies} />
        </div>
